...
from SimCLR.vg_train_simclr import vg_train_contrastive
...
def train(
    ...
    train_modules = ()
    rel_pn_module_ref = []
    if cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR == "ContrastivePredictor":
        eval_modules = [
            model.rpn,
            model.backbone,
            model.roi_heads.box,
            ...
            model.roi_heads.relation.predictor.sub_emb,
            model.roi_heads.relation.predictor.obj_emb,
            model.roi_heads.relation.predictor.context_encoder,
            model.roi_heads.relation.predictor.projector,
        ]    
    ...
    #s = "checkpoints/contrastive learning/(2023-06-07_15-35)/last_checkpoint"
    #s = "checkpoints/contrastive learning/(2023-06-07_22-39)/last_checkpoint"
    #s = "checkpoints/contrastive learning/(2023-06-10_15-19)/last_checkpoint"
    #s = "checkpoints/contrastive learning/(2023-06-12_17-30)/last_checkpoint"
    path = cfg.MODEL.CONTRASTIVE.PRETRAINED_MODEL
    #"checkpoints/contrastive learning/(2023-06-12_17-30)/model_0008800.pth"
    #f = open(s, "r")
    #path = f.readline()
    #f.close()
    ...
    load_state_dict(model.roi_heads.relation.predictor, checkpoint_sub.pop("model"), load_mapping_sub, )
    #####################################################################
...
def main():
    ...
    time_str = now.strftime("%Y-%m-%d_%H_%M")
